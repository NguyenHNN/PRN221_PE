...
public partial class OilPaintingArt2024DbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.OilPaintingArtId).HasName("PK__OilPaint__708184D846BB07BC");
        ...
        {
            entity.HasKey(e => e.SupplierId).HasName("PK__Supplier__4BE666B4274BCDE0");
        ...
        {
            entity.HasKey(e => e.AccountId).HasName("PK__SystemAc__349DA586A916D3D3");

            entity.ToTable("SystemAccount");

            entity.HasIndex(e => e.AccountEmail, "UQ__SystemAc__FC770D33BC9FD6E3").IsUnique();
